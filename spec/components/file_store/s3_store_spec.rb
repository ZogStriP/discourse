...
describe FileStore::S3Store do
  ...
  describe ".remove_avatars" do

    pending "calls remove_directory with the url" do
  ...
  describe ".has_been_uploaded?" do
    ...
    it "identifies S3 uploads" do
      store.has_been_uploaded?("//s3_upload_bucket.s3.amazonaws.com/1337.png").should be_true
    end

    it "does not match other s3 urls" do
      store.has_been_uploaded?("//s3.amazonaws.com/s3_upload_bucket/1337.png").should be_false
      store.has_been_uploaded?("//s4_upload_bucket.s3.amazonaws.com/1337.png").should be_false
    end
  ...
  it "is external" do
    store.external?.should be_true
    store.internal?.should be_false
  end
